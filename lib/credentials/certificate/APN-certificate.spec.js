...
describe('APNCertificateSpec', () => {
	...
	describe('validity', () => {
		test('returns an object containing notBefore', () => {
			expect(new APNCertificateSpec(cert).validity())
				.toHaveProperty('notBefore', new Date('2015-01-01T00:00:00Z'))
		})

		test('returns an object containing notAfter', () => {
			expect(new APNCertificateSpec(cert).validity())
				.toHaveProperty('notAfter',new Date('2025-01-01T00:00:00Z'))
		})
	})
