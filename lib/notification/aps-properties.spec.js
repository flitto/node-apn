	...
	describe('aps convenience properties', () => {
			...
			describe('alert is already an object', () => {
				...
				test('contains all expected properties', () => {
					expect(compiledOutput())
						.toHaveProperty('aps.alert', { body: 'Test', 'launch-image': 'test.png', title: 'node-apn' })
				})
			})
		...
		describe('subtitle', () => {
			...
			describe('alert is already an object', () => {
				...
				test('contains all expected properties', () => {
					expect(compiledOutput()).toHaveProperty('aps.alert',{ body: 'Test', 'launch-image': 'test.png', subtitle: 'node-apn' })
				})
			})
		...
		describe('titleLocArgs', () => {
			test('sets the aps.alert.title-loc-args property', () => {
				...
				expect(compiledOutput())
					.toHaveProperty('aps.alert.title-loc-args',	['arg1', 'arg2'])
			})
			...
			describe('alert is already a string', () => {
				...
				test('sets the aps.alert.title-loc-args property', () => {
					expect(compiledOutput())
						.toHaveProperty('aps.alert.title-loc-args',['Hi there'])
				})
			})
			...
			describe('setTitleLocArgs', () => {
				test('is chainable', () => {
					...
					expect(compiledOutput())
						.toHaveProperty('aps.alert.title-loc-args',['iPhone 6s'])
				})
			})
		})
		...
		describe('action', () => {
			...
			describe('alert is already an object', () => {
				...
				test('contains all expected properties', () => {
					expect(compiledOutput())
						.toHaveProperty('aps.alert',{ body: 'Test', 'launch-image': 'test.png', action: 'View' })
				})
			})
		...
		describe('launchImage', () => {
			test('sets the aps.alert.launch-image property', () => {
				...
				expect(compiledOutput())
					.toHaveProperty('aps.alert.launch-image','testLaunch.png')
			})
			...
			describe('alert is already a string', () => {
				...
				test('sets the aps.alert.launch-image property', () => {
					expect(compiledOutput())
						.toHaveProperty('aps.alert.launch-image','apnLaunch.png')
				})
			})
