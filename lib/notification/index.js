...
for (const method in setterMethods) {
  const methodName = 'set' + method[0].toUpperCase() + method.slice(1)
  Notification.prototype[methodName] = (value) => {
    this[propName] = value
    return this
  }
}
 ...
 * @since v1.3.0
 */
Notification.prototype.compile = () => {
  if(!this.compiled) {
