...
describe('Notification', () => {
  ...
  describe('rawPayload', () => {
    ...
    context('when passed in the notification constructor', () => {
      beforeEach(() => {
        note = new Notification({
  ...
  describe('payload', () => {
    ...
    describe('when aps properties are given by setters', () => {
      it('should not mutate the originally given paylaod object', () => {
    ...
    describe('when aps payload is present', () => {
      ...
      it('does not contain the aps properties', () => {
  ...
  describe('length', () => {
    it('returns the correct payload length', () => {
      note.alert = 'length'
  ...
  describe('headers', () => {
    it('contains no properties by default', () => {
      expect(note.headers()).to.deep.equal({})
    })

    context('priority is non-default', () => {
      it('contains the apns-priority header', () => {
        note.priority = 5
    ...
    context('id is set', () => {
      it('contains the apns-id header', () => {
    ...
    context('expiry is greater than zero', () => {
      it('contains the apns-expiration header', () => {
        note.expiry = 1000
    ...
    context('expiry is negative', () => {
      it('not contains the apns-expiration header', () => {
        note.expiry = -1
    ...
    context('topic is set', () => {
      it('contains the apns-topic header', () => {
    ...
    context('collapseId is set', () => {
      it('contains the apns-collapse-id header', () => {
    ...
    context('pushType is set', () => {
      it('contains the apns-push-type header', () => {
        note.pushType = 'alert'
  ...
  describe('compile', () => {
    ...
    it('re-compiles the JSON payload when `note.compiled` = false', () => {
      stub.returns('payload1')
      note.compile()
